...
if os.path.isfile(COCO_MODEL_PATH) == False:
    ...
    print("Success fully loaded mask_rcnn_coco.h5")#me
...
path_data = dir_path + "/Data/"  #input("Insert the path of Data [ Link /home/../ISIC-Archive-Downloader/Data/ ] : ")
...
print("model train 1 started")
model.train(dataset_train, dataset_val,
            learning_rate=config.LEARNING_RATE,
            epochs=20,
            layers='heads')# epochs = 30 default
print("model train 1 ends")

# After all the layers 
print("model train 2 started")
model.train(dataset_train, dataset_val,
            learning_rate=config.LEARNING_RATE/10,
            epochs=50,
            layers="all") # epochs = 90 default
print("model train 2 ends")
